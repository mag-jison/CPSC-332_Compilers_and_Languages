...
template <class T>
bool Tree<T>::isTerminal(Node<T>* curr){
   if (curr == nullptr)
      return false;
   else if (curr != nullptr){
      if (curr->value == "<TY>" || curr->value == "<ID>" || curr->value == "(" || curr->value == ")" || curr->value == "+" || curr->value == "-" || curr->value == "*" || curr->value == "/" || curr->value == "=" || curr->value == "<e>" || curr->value == "<NUM>")
         return true;
   }
   else
      return false;
...
void Tree<T>::insertRecursive(Node<T>* curr, Node<T>* key, bool& yes){
   if (curr == nullptr || isTerminal(curr))
      return;
